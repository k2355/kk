		...
		if(jQuery(".ckplayer-video-real").length){
			...
			jQuery(".ckplayer-video-real").each(function(){
				...
				if(jQuery(this).hasClass("video-blob")){
					jQuery(".single-video").append("<div class='single-video-loading' style='z-index: 9;position: absolute;top: calc(50% - 12px);left: 0;right: 0;color: #fff;font-size: 16px;text-align: center;'>视频加载中...</div>");
				    ...
				    xhr.onload = function (e) {
				        if (this.status == 200) { 
				            ...
				            jQuery(".single-video-loading").remove();
				            new ckplayer({
